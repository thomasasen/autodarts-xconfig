...
export const WIDTH_PROPERTY = "--ad-ext-x01-remaining-score-bar-width";
export const DEBUG_MAX_CARD_SAMPLES = 4;
export const COLOR_THEME_ATTRIBUTE = "data-ad-ext-x01-remaining-score-bar-color-theme";
export const SIZE_ATTRIBUTE = "data-ad-ext-x01-remaining-score-bar-size";
export const EFFECT_ATTRIBUTE = "data-ad-ext-x01-remaining-score-bar-effect";

const ACTIVE_STYLE_PROPERTIES = Object.freeze([
  "--ad-ext-x01-remaining-score-bar-track-base-active",
  "--ad-ext-x01-remaining-score-bar-fill-base-active",
  "--ad-ext-x01-remaining-score-bar-track-solid-active",
  "--ad-ext-x01-remaining-score-bar-fill-solid-active",
  "--ad-ext-x01-remaining-score-bar-fill-outline-active",
  "--ad-ext-x01-remaining-score-bar-fill-ambient-active",
  "--ad-ext-x01-remaining-score-bar-track-border-active",
  "--ad-ext-x01-remaining-score-bar-track-bg-active",
  "--ad-ext-x01-remaining-score-bar-fill-bg-active",
  "--ad-ext-x01-remaining-score-bar-fill-shadow-active",
  "--ad-ext-x01-remaining-score-bar-track-overlay-active",
  "--ad-ext-x01-remaining-score-bar-track-overlay-opacity-active",
  "--ad-ext-x01-remaining-score-bar-track-inner-shadow-active",
  "--ad-ext-x01-remaining-score-bar-track-backdrop-filter-active",
  "--ad-ext-x01-remaining-score-bar-fill-overlay-image-active",
  "--ad-ext-x01-remaining-score-bar-fill-overlay-size-active",
  "--ad-ext-x01-remaining-score-bar-fill-overlay-position-active",
...
const LEGACY_EFFECT_FILL_CLASS_LIST = Object.freeze([
  "ad-ext-x01-remaining-score-bar__fill--effect-electric-surge",
]);
...
const EFFECT_ANIMATION_SLOT = Symbol("adExtX01RemainingScoreBarEffectAnimation");
const TRAIL_ANIMATION_SLOT = Symbol("adExtX01RemainingScoreBarTrailAnimation");
const EFFECT_CHANGE_TOKEN_ATTRIBUTE = "data-ad-ext-x01-remaining-score-bar-effect-token";
const TRAIL_WIDTH_PROPERTY = "--ad-ext-x01-remaining-score-bar-trail-width";
...
export function resolveActiveVisualVars(options = {}) {
  ...
  return {
    ...
    "--ad-ext-x01-remaining-score-bar-fill-ambient-active": toRgba(
      palette?.mid || palette?.start,
      0.26
    ),
    "--ad-ext-x01-remaining-score-bar-track-border-active": toRgba(
...
function createEffectAnimationDefinition(effect) {
  ...
  if (normalizedEffect === "glass-light-sweep") {
    return {
      keyframes: [
  ...
  if (normalizedEffect === "moving-segments") {
    return {
      keyframes: [
  ...
  if (normalizedEffect === "fast-signal-sweep") {
    return {
      keyframes: [
...
function triggerScoreChangeEffect(
  ...
  if (normalizedEffect === "previous-score-trail") {
    clearTrailState(trailNode);
...
export function updateProgressHost(hostNode, options = {}) {
  ...
  setDatasetValueIfChanged(
    hostNode,
    "adExtX01RemainingScoreBarState",
