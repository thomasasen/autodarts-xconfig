...
#${PREVIEW_ID} .ad-ext-dart-marker-darts-preview-stage{width:100%;border:1px solid rgba(255,255,255,.2);border-radius:8px;background:linear-gradient(160deg,rgba(13,24,58,.92),rgba(25,32,71,.88));box-shadow:inset 0 0 0 1px rgba(126,216,255,.08);padding:.6rem}
#${PREVIEW_ID}[data-preview-mode="overlay"] .ad-ext-dart-marker-darts-preview-stage{width:min(34rem,calc(100vw - 2rem));border-radius:12px;background:linear-gradient(160deg,rgba(13,24,58,.98),rgba(25,32,71,.98));box-shadow:0 16px 44px rgba(0,0,0,.42);padding:.85rem}
#${PREVIEW_ID} .ad-ext-dart-marker-darts-preview-head{display:none;align-items:center;justify-content:space-between;gap:.75rem;margin-bottom:.55rem;color:#fff;font:700 .86rem "Open Sans","Segoe UI",Tahoma,sans-serif}
#${PREVIEW_ID}[data-preview-mode="overlay"] .ad-ext-dart-marker-darts-preview-head{display:flex}
#${PREVIEW_ID} .ad-ext-dart-marker-darts-preview-close{border:1px solid rgba(255,255,255,.26);border-radius:8px;background:rgba(255,255,255,.08);color:#fff;width:2rem;height:2rem;cursor:pointer}
...
#${PREVIEW_ID} .ad-ext-dart-marker-darts-preview-board{fill:rgba(8,16,36,.82);stroke:rgba(255,255,255,.2);stroke-width:2}
#${PREVIEW_ID} .ad-ext-dart-marker-darts-preview-board-band{fill:none;stroke:rgba(255,255,255,.14);stroke-width:12}
#${PREVIEW_ID} .ad-ext-dart-marker-darts-preview-segment{fill:rgba(126,216,255,.12);stroke:rgba(126,216,255,.42);stroke-width:1}
#${PREVIEW_ID} .ad-ext-dart-marker-darts-preview-ring{fill:none;stroke:rgba(126,216,255,.5);stroke-width:2;stroke-dasharray:5 5}
#${PREVIEW_ID} .ad-ext-dart-marker-darts-preview-marker{fill:rgb(49,130,206);stroke:#fff;stroke-width:1.5}
`;
  documentRef.head?.appendChild(style);
  return style;
}

function clearDartMarkerDartsPreview(windowRef) {
...
export function runDartMarkerDartsPreview(options = {}) {
  ...
  clearDartMarkerDartsPreview(windowRef);

  const visualConfig = resolveDartMarkerDartsConfig(options.featureConfig || {});
  ...
  stage.className = "ad-ext-dart-marker-darts-preview-stage";
  const head = documentRef.createElement("div");
  head.className = "ad-ext-dart-marker-darts-preview-head";
  const title = documentRef.createElement("span");
  title.textContent = "Virtueller Dart-Marker";
  const closeButton = documentRef.createElement("button");
  closeButton.type = "button";
  closeButton.className = "ad-ext-dart-marker-darts-preview-close";
  ...
  svg.appendChild(createSvgElement(documentRef, "circle", {
    ...
    cy: "84",
    r: "62",
    class: "ad-ext-dart-marker-darts-preview-board",
  }));
  svg.appendChild(createSvgElement(documentRef, "circle", {
    cx: "160",
    cy: "84",
    r: "42",
    class: "ad-ext-dart-marker-darts-preview-board-band",
  }));
  svg.appendChild(createSvgElement(documentRef, "path", {
    d: "M160 84 L200 36 A62 62 0 0 1 221 94 Z",
    class: "ad-ext-dart-marker-darts-preview-segment",
  }));
  svg.appendChild(createSvgElement(documentRef, "circle", {
    cx: "194",
    cy: "70",
    r: "15",
    class: "ad-ext-dart-marker-darts-preview-ring",
  }));
  const marker = createSvgElement(documentRef, "circle", {
    cx: "194",
    cy: "70",
    r: "6",
    class: "ad-ext-dart-marker-darts-preview-marker",
  });
  ...
  if (!isInlinePreview) {
    closeButton.addEventListener("click", () => clearDartMarkerDartsPreview(windowRef));
