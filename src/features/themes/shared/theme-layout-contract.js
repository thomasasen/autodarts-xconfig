...
export const CRICKET_STACK_ATTRIBUTE = "data-ad-ext-cricket-stack";
export const CRICKET_ROW_ATTRIBUTE = "data-ad-ext-cricket-row";
export const CRICKET_SLOT_ATTRIBUTE = "data-ad-ext-cricket-slot";
export const CRICKET_META_ATTRIBUTE = "data-ad-ext-cricket-meta";
export const CRICKET_IDENTITY_SHELL_ATTRIBUTE = "data-ad-ext-cricket-identity-shell";
export const CRICKET_META_SHELL_ATTRIBUTE = "data-ad-ext-cricket-meta-shell";
