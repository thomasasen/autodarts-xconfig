...
#${PANEL_HOST_ID} .ad-xconfig-card[data-preview-kind="dart-marker"] .ad-xconfig-card-bg::after{background:linear-gradient(90deg,rgba(15,27,67,.94) 0%,rgba(15,27,67,.88) 39%,rgba(15,27,67,.32) 68%,rgba(15,27,67,.1) 100%),linear-gradient(165deg,transparent 45%,rgba(126,216,255,.12) 46%,transparent 47%)}
#${PANEL_HOST_ID} .ad-xconfig-card[data-preview-kind="dart-marker"] .ad-xconfig-card-bg img{top:14%;right:-2%;width:64%;height:72%;object-fit:contain;object-position:right center;opacity:.92;filter:drop-shadow(0 0 7px rgba(126,216,255,.7)) drop-shadow(0 9px 12px rgba(2,8,28,.72));transform:rotate(-7deg) scale(1.03);transition:transform .28s ease,filter .28s ease}
...
#${PANEL_HOST_ID} .ad-xconfig-card[data-preview-kind="turn-score-counter"] .ad-xconfig-card-bg img{right:-18%;object-position:left bottom;opacity:.76;filter:saturate(1.12) contrast(1.08);transform:scale(1.18);transform-origin:left 74%}
