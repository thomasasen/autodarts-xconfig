...
const COLOR_PREVIEW_GRADIENTS = Object.freeze([
  ...
  ["x01-checkout-zone-blue", "repeating-linear-gradient(45deg,rgba(255,255,255,.16) 0 2px,transparent 2px 7px),linear-gradient(90deg,#0b55df 0%,#374c98 100%)", "34% 100%,100% 100%", "left center,left center", "rgba(255,255,255,.76)", "rgba(11,85,223,.58)", "rgba(55,76,152,.28)"],
...
#${PANEL_HOST_ID} .ad-xconfig-header{display:flex;flex-wrap:wrap;justify-content:space-between;align-items:center;gap:16px;padding:16px;border:1px solid var(--adx-border);border-radius:12px;background:var(--adx-surface)}
#${PANEL_HOST_ID} .ad-xconfig-header-lead{min-width:0;display:flex;flex:1 1 760px;flex-wrap:wrap;align-items:center;gap:16px}
#${PANEL_HOST_ID} .ad-xconfig-heading{min-width:190px}
...
#${PANEL_HOST_ID} .ad-xconfig-subtitle{margin:3px 0 0;font-size:12px;color:var(--adx-subtle)}
#${PANEL_HOST_ID} .ad-xconfig-back-btn{white-space:nowrap}
#${PANEL_HOST_ID} .ad-xconfig-notice{margin-top:.85rem;border-radius:8px;padding:.62rem .8rem;font-size:.85rem;border:1px solid transparent;display:flex;align-items:center;justify-content:space-between;gap:.75rem}
#${PANEL_HOST_ID} .ad-xconfig-notice-action{appearance:none;border:1px solid currentColor;border-radius:999px;padding:.28rem .58rem;background:transparent;color:inherit;font:800 .76rem/1 var(--adx-body);cursor:pointer;white-space:nowrap}
...
#${PANEL_HOST_ID} .ad-xconfig-update-head{display:flex;align-items:center;justify-content:space-between;gap:.75rem;flex-wrap:wrap}
...
#${PANEL_HOST_ID} .ad-xconfig-section{--adx-section-accent:#94a3b8;display:grid;gap:0}
#${PANEL_HOST_ID} .ad-xconfig-section + .ad-xconfig-section{margin-top:36px;padding-top:36px;border-top:1px solid var(--adx-border)}
#${PANEL_HOST_ID} .ad-xconfig-section[data-adxconfig-section="template"]{--adx-section-accent:#a855f7}
#${PANEL_HOST_ID} .ad-xconfig-section[data-adxconfig-section="all-modes"]{--adx-section-accent:#38bdf8}
#${PANEL_HOST_ID} .ad-xconfig-section[data-adxconfig-section="x01"]{--adx-section-accent:#84cc16}
#${PANEL_HOST_ID} .ad-xconfig-section[data-adxconfig-section="cricket-tactics"]{--adx-section-accent:#f59e0b}
#${PANEL_HOST_ID} .ad-xconfig-section-header{display:flex;align-items:center;justify-content:space-between;gap:16px;padding:14px 16px;border-left:4px solid var(--adx-section-accent);border-radius:0 10px 10px 0;background:linear-gradient(90deg,color-mix(in srgb,var(--adx-section-accent) 13%,transparent),rgba(255,255,255,.025))}
#${PANEL_HOST_ID} .ad-xconfig-section-heading{min-width:0}
#${PANEL_HOST_ID} .ad-xconfig-section-eyebrow{display:block;margin-bottom:2px;color:var(--adx-section-accent);font-size:10px;font-weight:900;letter-spacing:.12em;text-transform:uppercase}
#${PANEL_HOST_ID} .ad-xconfig-section-title{margin:0;color:var(--adx-text);font:28px/1.1 var(--adx-display)}
#${PANEL_HOST_ID} .ad-xconfig-section-description{margin:4px 0 0;color:var(--adx-subtle);font-size:13px}
#${PANEL_HOST_ID} .ad-xconfig-section-count{flex:0 0 auto;padding:.28rem .58rem;border:1px solid color-mix(in srgb,var(--adx-section-accent) 48%,transparent);border-radius:999px;background:color-mix(in srgb,var(--adx-section-accent) 10%,transparent);color:var(--adx-text);font-size:11px;font-weight:800;white-space:nowrap}
...
#${PANEL_HOST_ID} .ad-xconfig-card{position:relative;overflow:hidden;min-width:0;min-height:224px;border-radius:12px;border:0;background:rgb(27,31,41);display:flex;flex-direction:column;box-shadow:inset 0 0 0 1px rgba(255,255,255,.045),0 8px 22px rgba(0,0,0,.18);transition:box-shadow .14s cubic-bezier(.2,.6,.2,1)}
#${PANEL_HOST_ID} .ad-xconfig-card[data-enabled="true"]{box-shadow:inset 0 0 0 2px var(--color-brand-blue-50,#4a89ff),0 0 0 1px rgba(74,137,255,.2),0 8px 22px rgba(0,0,0,.22)}
#${PANEL_HOST_ID} .ad-xconfig-card[data-enabled="true"]::after{content:"";position:absolute;z-index:8;inset:0;border:2px solid var(--color-brand-blue-50,#4a89ff);border-radius:inherit;pointer-events:none}
#${PANEL_HOST_ID} .ad-xconfig-card--theme-global{grid-column:1/-1}
#${PANEL_HOST_ID} .ad-xconfig-card-bg{position:absolute;z-index:0;inset:0 0 0 33.333%;height:auto;overflow:hidden;pointer-events:none;background:var(--adx-raised);border:0}
#${PANEL_HOST_ID} .ad-xconfig-card-bg::after{content:"";position:absolute;z-index:1;inset:0;background:linear-gradient(90deg,rgba(27,31,41,.92) 0%,rgba(27,31,41,.72) 35%,rgba(27,31,41,.44) 62%,rgba(27,31,41,.16) 82%,rgba(27,31,41,.02) 100%)}
#${PANEL_HOST_ID} .ad-xconfig-card-bg img{display:block;width:100%;height:100%;object-fit:cover;object-position:center}
#${PANEL_HOST_ID} .ad-xconfig-card[data-preview-kind^="theme-global-"][data-preview-display-mode="fit"] .ad-xconfig-card-bg img{object-fit:contain}
#${PANEL_HOST_ID} .ad-xconfig-card[data-preview-kind^="theme-global-"][data-preview-display-mode="stretch"] .ad-xconfig-card-bg img{object-fit:fill}
#${PANEL_HOST_ID} .ad-xconfig-card[data-preview-kind^="theme-global-"][data-preview-display-mode="center"] .ad-xconfig-card-bg img{object-fit:none}
#${PANEL_HOST_ID} .ad-xconfig-card[data-preview-kind^="theme-global-"][data-preview-display-mode="tile"] .ad-xconfig-card-bg img{object-fit:none;object-position:left top}
#${PANEL_HOST_ID} .ad-xconfig-card[data-preview-kind="theme-global-typography"] .ad-xconfig-card-bg img,#${PANEL_HOST_ID} .ad-xconfig-card[data-preview-kind="theme-global-presets"] .ad-xconfig-card-bg img{filter:brightness(.48) saturate(.9)}
#${PANEL_HOST_ID} .ad-xconfig-card[data-preview-kind="theme-game-layout"] .ad-xconfig-card-bg img{filter:brightness(.16) saturate(.55)}
#${PANEL_HOST_ID} .ad-xconfig-card[data-preview-kind="theme-game-layout"] .ad-xconfig-feature-card-preview{position:absolute;z-index:2;inset:0;padding:14px;background:linear-gradient(90deg,rgba(4,10,24,.2),rgba(4,10,24,.5))}
#${PANEL_HOST_ID} .ad-xconfig-game-layout-preview{position:relative;display:grid;grid-template-columns:minmax(9rem,38%) minmax(0,1fr);gap:.45rem;width:100%;height:100%;min-height:9.5rem;color:#f7fbff}
#${PANEL_HOST_ID} .ad-xconfig-game-layout-preview-rail{display:grid;grid-template-rows:2.15rem minmax(0,1fr) minmax(0,.6fr) minmax(0,.6fr);gap:.3rem;min-width:0}
#${PANEL_HOST_ID} .ad-xconfig-game-layout-preview-turn{display:grid;place-items:center;border-radius:.45rem;background:rgba(9,21,43,.92);font-family:monospace;font-weight:900;font-size:.72rem;letter-spacing:.04em}
#${PANEL_HOST_ID} .ad-xconfig-game-layout-preview-player{display:grid;grid-template-columns:minmax(0,1fr) auto 1.35rem;grid-template-rows:1fr 1fr;align-items:center;column-gap:.18rem;padding:.26rem .42rem;border-radius:.45rem;background:rgba(16,24,39,.94);border:1px solid rgba(255,255,255,.1);font-size:.62rem;font-weight:800;overflow:hidden}
#${PANEL_HOST_ID} .ad-xconfig-game-layout-preview-player.is-active{border-color:rgba(159,219,88,.9);background:linear-gradient(135deg,rgba(84,18,52,.96),rgba(28,20,43,.96))}
#${PANEL_HOST_ID} .ad-xconfig-game-layout-preview-player:not(.is-active)>*{filter:grayscale(1);opacity:.55;zoom:.6}
#${PANEL_HOST_ID} .ad-xconfig-game-layout-preview-player:not(.is-active)>span:first-child{zoom:.84}
#${PANEL_HOST_ID} .ad-xconfig-game-layout-preview-player>span{grid-column:1;grid-row:1;font-size:.7rem;font-weight:900;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
#${PANEL_HOST_ID} .ad-xconfig-game-layout-preview-player>strong{grid-column:2;grid-row:1/span 2;align-self:end;font-family:monospace;font-size:1.7rem;line-height:.84}
#${PANEL_HOST_ID} .ad-xconfig-game-layout-preview-player>small{display:block;grid-column:1;grid-row:2;align-self:start;color:#d7deea;font-size:.5rem;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
#${PANEL_HOST_ID} .ad-xconfig-game-layout-preview-player>.ad-xconfig-game-layout-preview-darts{grid-column:3;grid-row:1;justify-self:center;font-size:.52rem}
#${PANEL_HOST_ID} .ad-xconfig-game-layout-preview-player>.ad-xconfig-game-layout-preview-legs{grid-column:3;grid-row:2;align-self:end;justify-self:center;min-width:1rem;padding:.08rem .2rem;border-radius:.2rem;background:#090d16;font:900 .58rem/1 monospace;text-align:center}
#${PANEL_HOST_ID} .ad-xconfig-game-layout-preview-board{position:relative;align-self:center;justify-self:end;width:min(100%,11rem);aspect-ratio:1;border-radius:50%;background:repeating-conic-gradient(#111 0deg 9deg,#ece2cc 9deg 18deg);box-shadow:inset 0 0 0 9px #20242b,inset 0 0 0 12px #d8d8d8,0 8px 20px rgba(0,0,0,.42)}
#${PANEL_HOST_ID} .ad-xconfig-game-layout-preview-board::before{content:"";position:absolute;inset:31%;border-radius:50%;background:repeating-conic-gradient(#0d5f44 0deg 9deg,#a72632 9deg 18deg);box-shadow:0 0 0 4px #d8d8d8}
#${PANEL_HOST_ID} .ad-xconfig-game-layout-preview-bull{position:absolute;z-index:2;left:50%;top:50%;width:9%;aspect-ratio:1;transform:translate(-50%,-50%);border-radius:50%;background:#c32639;box-shadow:0 0 0 3px #17845f}
#${PANEL_HOST_ID} .ad-xconfig-game-layout-preview-dock{position:absolute;z-index:3;right:.35rem;bottom:.35rem;display:flex;align-items:center;gap:.25rem;padding:.25rem;border-radius:.55rem;background:#042963;box-shadow:0 .35rem .8rem rgba(0,0,0,.38)}
#${PANEL_HOST_ID} .ad-xconfig-game-layout-preview-dock>span{display:grid;place-items:center;min-width:1.55rem;min-height:1.35rem;padding:0 .22rem;border-radius:.35rem;background:rgba(255,255,255,.1);font-size:.58rem;font-weight:850}
#${PANEL_HOST_ID} .ad-xconfig-game-layout-preview-dock>span:last-child{background:#1677d2}
#${PANEL_HOST_ID} .ad-xconfig-card[data-preview-kind="theme-global-typography"] .ad-xconfig-feature-card-preview,#${PANEL_HOST_ID} .ad-xconfig-card[data-preview-kind="theme-global-presets"] .ad-xconfig-feature-card-preview{position:absolute;z-index:2;inset:0;display:flex;align-items:center;padding:16px;background:linear-gradient(90deg,rgba(4,10,24,.2),rgba(4,10,24,.58))}
#${PANEL_HOST_ID} .ad-xconfig-card[data-preview-kind="theme-global-presets"] .ad-xconfig-feature-card-preview{justify-content:flex-end;background:linear-gradient(90deg,rgba(4,10,24,.08),rgba(4,10,24,.64))}
#${PANEL_HOST_ID} .ad-xconfig-theme-card-preview-sample{--ad-xconfig-theme-card-accent:#69d4ff;--ad-xconfig-theme-card-score:#fff;--ad-xconfig-theme-card-secondary:#dce9ff;--ad-xconfig-theme-card-throw:#9fdb58;display:grid;grid-template-columns:minmax(0,1fr) auto minmax(0,1fr);grid-template-areas:"label label label" "player throw opponent";align-items:stretch;gap:6px;width:min(100%,25rem);padding:10px;border:1px solid color-mix(in srgb,var(--ad-xconfig-theme-card-accent) 70%,white 30%);border-radius:9px;background:rgba(8,14,28,.86);box-shadow:0 8px 22px rgba(0,0,0,.38),inset 0 0 0 1px rgba(255,255,255,.05);text-shadow:0 2px 8px rgba(0,0,0,.9)}
#${PANEL_HOST_ID} .ad-xconfig-theme-card-preview-label{grid-area:label;color:var(--ad-xconfig-theme-card-accent);font-size:.65rem;font-weight:900;letter-spacing:.07em;text-transform:uppercase}
#${PANEL_HOST_ID} .ad-xconfig-theme-card-preview-player{grid-area:player;display:grid;gap:3px;min-width:0;padding:7px 8px;border:1px solid rgba(255,255,255,.14);border-radius:7px;background:rgba(8,12,24,.93)}
...
#${PANEL_HOST_ID} .ad-xconfig-card[data-preview-kind="checkout-suggestion-style"] .ad-xconfig-feature-card-preview{position:absolute;z-index:2;top:50%;right:3%;width:min(76%,19rem);transform:translateY(-50%);filter:drop-shadow(0 12px 18px rgba(2,8,28,.55));opacity:.94}
...
#${PANEL_HOST_ID} .ad-xconfig-card[data-preview-kind="x01-bust-active-player-highlight"] .ad-xconfig-card-bg img{filter:brightness(.2) saturate(.5)}
#${PANEL_HOST_ID} .ad-xconfig-card[data-preview-kind="x01-bust-active-player-highlight"] .ad-xconfig-feature-card-preview{position:absolute;z-index:2;inset:0;display:grid;place-items:center;padding:16px 12px 16px 28px;background:linear-gradient(90deg,rgba(27,31,41,.5),rgba(8,11,18,.32))}
...
#${PANEL_HOST_ID} .ad-xconfig-card-title{margin:0;display:flex;align-items:center;font:700 16px/1.4 var(--adx-body);overflow-wrap:anywhere}
#${PANEL_HOST_ID} .ad-xconfig-card-settings-icon{display:inline-flex;align-items:center;justify-content:center;flex:0 0 20px;width:20px;height:20px;margin-left:8px;padding:0;border:0;background:transparent;color:rgba(255,255,255,.9);cursor:pointer}
#${PANEL_HOST_ID} .ad-xconfig-card-settings-icon:hover,#${PANEL_HOST_ID} .ad-xconfig-card-settings-icon:focus-visible{color:#fff;filter:drop-shadow(0 0 5px rgba(255,255,255,.35))}
#${PANEL_HOST_ID} .ad-xconfig-card-settings-icon:focus-visible{outline:2px solid var(--color-brand-blue-50,#4a89ff);outline-offset:3px;border-radius:4px}
#${PANEL_HOST_ID} .ad-xconfig-card-settings-icon svg{display:block;width:20px;height:20px}
...
#${PANEL_HOST_ID} .ad-xconfig-card-title,#${PANEL_HOST_ID} .ad-xconfig-card-copy,#${PANEL_HOST_ID} .ad-xconfig-switch-state{text-shadow:0 2px 7px rgba(0,0,0,.88)}
...
#${PANEL_HOST_ID} .ad-xconfig-status-badge--diagnostic{border:1px solid #f7c948;background:rgba(247,201,72,.12);color:#f7c948}
...
#${PANEL_HOST_ID} .ad-xconfig-card-actions{margin-top:auto;padding-top:16px;display:flex;gap:8px;flex-wrap:wrap}
...
#${PANEL_HOST_ID} .ad-xconfig-checkout-suggestion-demo{position:relative;isolation:isolate;width:min(100%,31.5rem);min-height:5rem;display:grid;grid-template-columns:repeat(3,minmax(0,1fr)) minmax(2.8rem,.8fr);align-items:stretch;gap:.5rem;padding:.5rem;border-radius:14px;background:rgba(6,11,22,.72);color:#fff;font-family:var(--adx-body);box-sizing:border-box}
#${PANEL_HOST_ID} .ad-xconfig-checkout-suggestion-demo-field,#${PANEL_HOST_ID} .ad-xconfig-checkout-suggestion-demo-total{position:relative;isolation:isolate;display:grid;place-items:center;min-width:0;min-height:4rem;border-radius:10px;background:linear-gradient(160deg,rgba(3,7,14,.86),color-mix(in srgb,var(--ad-ext-accent-soft) 34%,rgba(3,7,14,.72)));border:1px solid color-mix(in srgb,var(--ad-ext-accent) 42%,rgba(255,255,255,.2));box-shadow:inset 0 0 0 1px rgba(255,255,255,.04);overflow:hidden}
...
#${PANEL_HOST_ID} .ad-xconfig-checkout-suggestion-demo--stripe .ad-xconfig-checkout-suggestion-demo-field{border-left:6px solid var(--ad-ext-accent);background:linear-gradient(100deg,var(--ad-ext-accent-soft),rgba(3,7,14,.82) 42%)}
#${PANEL_HOST_ID} .ad-xconfig-checkout-suggestion-demo--ticket .ad-xconfig-checkout-suggestion-demo-field{border:2px dashed color-mix(in srgb,var(--ad-ext-accent) 76%,rgba(255,255,255,.28))}
#${PANEL_HOST_ID} .ad-xconfig-checkout-suggestion-demo--outline .ad-xconfig-checkout-suggestion-demo-field{border:2px solid var(--ad-ext-accent);box-shadow:inset 0 0 0 1px rgba(255,255,255,.24),0 0 12px color-mix(in srgb,var(--ad-ext-accent-strong) 58%,transparent)}
...
#${PANEL_HOST_ID} .ad-xconfig-checkout-suggestion-demo--mini{width:100%;min-height:3rem;gap:.18rem;padding:.22rem;border-radius:9px}
#${PANEL_HOST_ID} .ad-xconfig-checkout-suggestion-demo--mini .ad-xconfig-checkout-suggestion-demo-field,#${PANEL_HOST_ID} .ad-xconfig-checkout-suggestion-demo--mini .ad-xconfig-checkout-suggestion-demo-total{min-height:2.55rem;border-radius:6px}
#${PANEL_HOST_ID} .ad-xconfig-checkout-suggestion-demo--mini .ad-xconfig-checkout-suggestion-demo-segment,#${PANEL_HOST_ID} .ad-xconfig-checkout-suggestion-demo--mini .ad-xconfig-checkout-suggestion-demo-total{font-size:.68rem}
#${PANEL_HOST_ID} .ad-xconfig-checkout-suggestion-demo--mini .ad-xconfig-checkout-suggestion-demo-label{top:-4px;left:2px;padding:1px 2px;font-size:4px;letter-spacing:0}
...
#${PANEL_HOST_ID} .ad-xconfig-option-item--x01-remaining-score-bar-preview{overflow:hidden}
...
#${PANEL_HOST_ID} .ad-xconfig-setting-row--special-hit-highlights-preview{padding:.72rem}
#${PANEL_HOST_ID} .ad-xconfig-special-hit-highlights-preview-surface{display:grid;gap:.45rem;width:min(20rem,100%);justify-self:center;box-sizing:border-box;border-radius:9px;border:1px solid rgba(255,255,255,.14);background:linear-gradient(135deg,rgba(7,14,30,.74),rgba(15,23,42,.58));padding:.65rem}
#${PANEL_HOST_ID} .ad-xconfig-special-hit-highlights-preview-head{display:flex;align-items:flex-end;justify-content:space-between;gap:.75rem;color:rgba(255,255,255,.92)}
#${PANEL_HOST_ID} .ad-xconfig-special-hit-highlights-preview-title{font-weight:900;font-size:.88rem;letter-spacing:.05em;text-transform:uppercase;color:rgba(196,230,255,.96)}
#${PANEL_HOST_ID} .ad-xconfig-special-hit-highlights-preview-route{font-size:.7rem;font-weight:800;letter-spacing:.05em;text-transform:uppercase;color:rgba(255,255,255,.68);white-space:nowrap}
#${PANEL_HOST_ID} .ad-xconfig-special-hit-highlights-preview-card{container-type:inline-size;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:0;width:6.75rem;height:5rem;min-height:0;justify-self:center;padding:.625rem 0 0;box-sizing:border-box;font-family:inherit}
#${PANEL_HOST_ID} .ad-xconfig-special-hit-highlights-preview-card::before{content:attr(data-adxconfig-special-hit-highlights-preview-score)}
#${PANEL_HOST_ID} .ad-xconfig-special-hit-highlights-preview-card>.ad-xconfig-special-hit-highlights-preview-segment{align-self:center}
...
#${PANEL_HOST_ID} .ad-xconfig-modal-backdrop{position:fixed;inset:64px 0 0;z-index:40;background:rgba(1,4,11,.72);display:flex;align-items:center;justify-content:center;padding:16px}
#${PANEL_HOST_ID} .ad-xconfig-modal{box-sizing:border-box;width:min(704px,100%);max-height:calc(100dvh - 96px);overflow:auto;overscroll-behavior:contain;border-radius:12px;border:1px solid var(--adx-border);background:var(--adx-surface);padding:0 24px 24px;color:var(--adx-text)}
...
#${PANEL_HOST_ID} .ad-xconfig-theme-preset-card{--ad-xconfig-theme-preset-accent:#69d4ff;--ad-xconfig-theme-preset-score:#fff;--ad-xconfig-theme-preset-secondary:rgba(235,243,255,.9);--ad-xconfig-theme-preset-throw:rgba(235,243,255,.72);--ad-xconfig-theme-preset-overlay-alpha:.75;--ad-xconfig-theme-preset-player-alpha:.9;--ad-xconfig-theme-preset-tint:15%;--ad-xconfig-theme-preset-font:inherit;--ad-xconfig-theme-preset-throw-font:Inter,Arial,sans-serif;appearance:none;position:relative;isolation:isolate;display:block;width:100%;height:100%;min-height:8.25rem;overflow:hidden;border:1px solid rgba(255,255,255,.22);border-radius:10px;padding:0;background:linear-gradient(145deg,rgba(8,13,26,.98),rgba(14,23,42,.96));color:#fff;text-align:left;cursor:pointer;box-shadow:inset 0 0 0 1px rgba(255,255,255,.05),0 5px 14px rgba(0,0,0,.2);transition:border-color .16s ease,box-shadow .16s ease,transform .16s ease}
...
#${PANEL_HOST_ID} .ad-xconfig-theme-preset-card[data-theme-preset-state="active"]{border-color:var(--ad-xconfig-theme-preset-accent);box-shadow:inset 0 0 0 2px color-mix(in srgb,var(--ad-xconfig-theme-preset-accent) 72%,transparent),0 7px 20px color-mix(in srgb,var(--ad-xconfig-theme-preset-accent) 25%,rgba(0,0,0,.3))}
#${PANEL_HOST_ID} .ad-xconfig-theme-preset-card[data-theme-preset-state="customized"]{border-color:color-mix(in srgb,var(--ad-xconfig-theme-preset-accent) 58%,rgba(255,255,255,.28))}
#${PANEL_HOST_ID} .ad-xconfig-theme-preset-card[data-theme-preset-state="disabled"]{filter:saturate(.58);opacity:.82}
...
#${PANEL_HOST_ID} .ad-xconfig-theme-preset-content{position:relative;display:grid;grid-template-columns:minmax(0,1fr) 3.4rem minmax(0,1fr);grid-template-areas:"identity identity identity" "player turn opponent";align-items:stretch;gap:.48rem;min-height:8.25rem;padding:.65rem}
#${PANEL_HOST_ID} .ad-xconfig-theme-preset-identity{grid-area:identity;display:flex;min-width:0;flex-wrap:wrap;align-items:center;gap:.34rem .48rem}
...
#${PANEL_HOST_ID} .ad-xconfig-theme-preset-wallpaper-state{color:rgba(235,243,255,.72);font-size:.68rem;font-weight:700;line-height:1.1}
#${PANEL_HOST_ID} .ad-xconfig-theme-preset-state{padding:.16rem .36rem;border:1px solid rgba(255,255,255,.24);border-radius:999px;background:rgba(7,13,26,.76);font:800 .62rem/1 Inter,Arial,sans-serif;color:rgba(239,246,255,.92)}
#${PANEL_HOST_ID} .ad-xconfig-theme-preset-state--active{border-color:var(--ad-xconfig-theme-preset-accent);color:#fff}
#${PANEL_HOST_ID} .ad-xconfig-theme-preset-swatches{display:flex;gap:.25rem;margin-left:auto}
#${PANEL_HOST_ID} .ad-xconfig-theme-preset-swatch{display:block;width:1.15rem;height:.42rem;border-radius:999px;border:1px solid rgba(255,255,255,.32);box-shadow:0 1px 3px rgba(0,0,0,.35)}
#${PANEL_HOST_ID} .ad-xconfig-theme-preset-player{grid-area:player;position:relative;display:grid;grid-template-rows:auto 1fr auto;align-items:center;gap:.25rem;min-width:0;padding:.48rem;border:1px solid color-mix(in srgb,var(--ad-xconfig-theme-preset-accent) 58%,rgba(255,255,255,.16));border-radius:7px;background:linear-gradient(180deg,color-mix(in srgb,var(--ad-xconfig-theme-preset-accent) var(--ad-xconfig-theme-preset-tint),transparent),transparent),rgba(8,12,24,var(--ad-xconfig-theme-preset-player-alpha));box-shadow:inset 0 0 0 1px rgba(255,255,255,.04)}
#${PANEL_HOST_ID} .ad-xconfig-theme-preset-player--opponent{grid-area:opponent;border-color:rgba(255,255,255,.16);background:rgba(8,12,24,var(--ad-xconfig-theme-preset-player-alpha))}
#${PANEL_HOST_ID} .ad-xconfig-theme-preset-player-name{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--ad-xconfig-theme-preset-secondary);font-family:var(--ad-xconfig-theme-preset-font);font-size:.66rem;font-weight:800;letter-spacing:.04em;line-height:1}
#${PANEL_HOST_ID} .ad-xconfig-theme-preset-score{align-self:end;color:var(--ad-xconfig-theme-preset-score);font-family:var(--ad-xconfig-theme-preset-font);font-size:1.62rem;font-weight:900;line-height:.9;text-shadow:0 1px 5px rgba(0,0,0,.75)}
#${PANEL_HOST_ID} .ad-xconfig-theme-preset-throw{align-self:end;padding:.15rem .28rem;border:1px solid color-mix(in srgb,var(--ad-xconfig-theme-preset-throw) 72%,transparent);border-radius:4px;color:var(--ad-xconfig-theme-preset-throw);font-family:var(--ad-xconfig-theme-preset-throw-font);font-size:.62rem;font-weight:800;line-height:1}
#${PANEL_HOST_ID} .ad-xconfig-theme-preset-turn{grid-area:turn;align-self:center;white-space:pre-line;text-align:center;color:var(--ad-xconfig-theme-preset-throw);font:900 .66rem/1.35 var(--ad-xconfig-theme-preset-throw-font);text-shadow:0 1px 5px rgba(0,0,0,.8)}
#${PANEL_HOST_ID} .ad-xconfig-setting-action-preview{display:block;width:100%;min-height:8.5rem}
#${PANEL_HOST_ID} .ad-xconfig-x01-bust-preview{display:grid;place-items:center;min-height:9rem;padding:.55rem;border-radius:12px;border:1px solid rgba(255,255,255,.12);background:linear-gradient(145deg,rgba(6,9,18,.94),rgba(15,19,31,.9))}
#${PANEL_HOST_ID} .ad-xconfig-x01-bust-preview-card{position:relative;width:min(100%,28rem);min-height:7.7rem;border:2px solid rgba(132,255,77,.76);border-radius:18px;overflow:hidden;background:linear-gradient(145deg,rgba(22,29,43,.98),rgba(10,14,24,.96));box-shadow:inset 0 0 0 1px rgba(255,255,255,.04),0 10px 24px rgba(0,0,0,.28)}
#${PANEL_HOST_ID} .ad-xconfig-x01-bust-preview--catalog{min-height:0;width:100%;padding:0;border:0;background:transparent}
#${PANEL_HOST_ID} .ad-xconfig-x01-bust-preview--catalog .ad-xconfig-x01-bust-preview-card{min-height:6.4rem;border-radius:15px}
#${PANEL_HOST_ID} .ad-xconfig-x01-bust-preview--catalog .ad-xconfig-x01-bust-preview-stack{min-height:6.4rem;padding:.85rem .8rem .62rem 3rem}
#${PANEL_HOST_ID} .ad-xconfig-x01-bust-preview-card--bust{border-color:rgb(217,31,62);background:linear-gradient(145deg,rgba(48,10,20,.97),rgba(18,20,27,.96));box-shadow:inset 0 0 0 999px rgba(217,31,62,.16),0 0 18px rgba(217,31,62,.32)}
#${PANEL_HOST_ID} .ad-xconfig-x01-bust-preview-route{position:absolute;left:.55rem;top:.55rem;z-index:2;display:grid;place-items:center;min-width:2.15rem;height:1.65rem;padding:0 .42rem;border-radius:999px;background:rgba(4,8,15,.82);border:1px solid rgba(255,255,255,.18);color:rgba(247,250,255,.9);font-size:.72rem;font-weight:800}
#${PANEL_HOST_ID} .ad-xconfig-x01-bust-preview-stack{display:grid;grid-template-rows:auto 1fr auto;gap:.7rem;min-height:7.7rem;padding:1rem 1rem .72rem 3.25rem;color:#fff}
...
#${PANEL_HOST_ID} .ad-xconfig-x01-bust-preview-leg{width:.62rem;height:.62rem;border-radius:999px;background:#84ff4d;box-shadow:0 0 10px rgba(132,255,77,.5)}
#${PANEL_HOST_ID} .ad-xconfig-x01-bust-preview-name{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:1.05rem;font-weight:850;line-height:1;letter-spacing:.01em;color:rgba(246,249,255,.96)}
#${PANEL_HOST_ID} .ad-xconfig-x01-bust-preview-score{font-size:3rem;font-weight:900;line-height:.9;font-variant-numeric:tabular-nums;color:#fff}
#${PANEL_HOST_ID} .ad-xconfig-x01-bust-preview-meta{align-self:center;color:rgba(218,226,239,.76);font-size:.84rem;font-weight:650}
#${PANEL_HOST_ID} .ad-xconfig-x01-bust-preview-bar{height:.35rem;border-radius:999px;background:linear-gradient(90deg,#84ff4d,#b5ff6d);box-shadow:0 0 12px rgba(132,255,77,.28)}
...
@media(max-width:1023px){#${PANEL_HOST_ID} .ad-xconfig-grid{grid-template-columns:1fr}#${PANEL_HOST_ID} .ad-xconfig-card--theme-global{grid-column:auto}#${PANEL_HOST_ID} .ad-xconfig-card--theme-global .ad-xconfig-card-content{width:70%}}
...
@media(max-width:640px){#${PANEL_HOST_ID} .ad-xconfig-special-hit-highlights-preview-head{align-items:flex-start;flex-direction:column;gap:.3rem}}
...
#${PANEL_HOST_ID} .ad-xconfig-switch{position:relative;display:inline-flex;align-items:center;gap:8px;flex:0 0 114px;width:114px;height:44px;cursor:pointer;margin:0}
...
#${PANEL_HOST_ID} .ad-xconfig-switch-track{box-sizing:border-box;position:relative;flex:0 0 48px;width:48px;height:28px;border:1px solid #77808f;border-radius:999px;background:#353b46;box-shadow:inset 0 1px 2px rgba(0,0,0,.36);transition:background-color .14s cubic-bezier(.2,.6,.2,1),border-color .14s cubic-bezier(.2,.6,.2,1),box-shadow .14s cubic-bezier(.2,.6,.2,1)}
#${PANEL_HOST_ID} .ad-xconfig-switch-thumb{position:absolute;top:3px;left:3px;width:20px;height:20px;border-radius:50%;background:#f7f8fa;box-shadow:0 1px 4px rgba(0,0,0,.48);transition:transform .14s cubic-bezier(.2,.6,.2,1)}
#${PANEL_HOST_ID} .ad-xconfig-switch-state{display:grid;align-items:center;min-width:58px;color:#d8dde7;font:800 13px/1 var(--adx-body);white-space:nowrap}
#${PANEL_HOST_ID} .ad-xconfig-switch-option{grid-area:1/1;transition:color .12s cubic-bezier(.2,.6,.2,1),opacity .12s cubic-bezier(.2,.6,.2,1),transform .12s cubic-bezier(.2,.6,.2,1)}
#${PANEL_HOST_ID} .ad-xconfig-switch-option--on{color:#d9e8ff;opacity:0;transform:translateY(2px)}
#${PANEL_HOST_ID} .ad-xconfig-switch-option--off{opacity:1;transform:translateY(0)}
#${PANEL_HOST_ID} .ad-xconfig-switch-input:checked + .ad-xconfig-switch-track{border-color:#8ab4ff;background:var(--color-brand-blue-50,#4a89ff);box-shadow:inset 0 1px 2px rgba(0,32,92,.34),0 0 0 1px rgba(74,137,255,.18)}
#${PANEL_HOST_ID} .ad-xconfig-switch-input:checked + .ad-xconfig-switch-track .ad-xconfig-switch-thumb{transform:translateX(20px)}
#${PANEL_HOST_ID} .ad-xconfig-switch-input:checked ~ .ad-xconfig-switch-state .ad-xconfig-switch-option--on{opacity:1;transform:translateY(0)}
#${PANEL_HOST_ID} .ad-xconfig-switch-input:checked ~ .ad-xconfig-switch-state .ad-xconfig-switch-option--off{opacity:0;transform:translateY(-2px)}
#${PANEL_HOST_ID} .ad-xconfig-switch-input:not(:disabled):hover + .ad-xconfig-switch-track{border-color:#a9b2c0}
#${PANEL_HOST_ID} .ad-xconfig-switch-input:checked:not(:disabled):hover + .ad-xconfig-switch-track{border-color:#bfd4ff;background:#5b95ff}
...
#${PANEL_HOST_ID} .ad-xconfig-switch-input:disabled + .ad-xconfig-switch-track,#${PANEL_HOST_ID} .ad-xconfig-switch-input:disabled ~ .ad-xconfig-switch-state{opacity:.5}
...
@media(max-width:640px){#${PANEL_HOST_ID} .ad-xconfig-page{padding:16px}#${PANEL_HOST_ID} .ad-xconfig-header{padding:12px}#${PANEL_HOST_ID} .ad-xconfig-header-lead{align-items:flex-start}#${PANEL_HOST_ID} .ad-xconfig-heading{flex:1 1 180px}#${PANEL_HOST_ID} .ad-xconfig-update-panel{min-width:100%}#${PANEL_HOST_ID} .ad-xconfig-header-actions{width:100%;justify-content:flex-start}#${PANEL_HOST_ID} .ad-xconfig-section + .ad-xconfig-section{margin-top:28px;padding-top:28px}#${PANEL_HOST_ID} .ad-xconfig-section-header{align-items:flex-start;padding:12px}#${PANEL_HOST_ID} .ad-xconfig-grid{gap:16px}#${PANEL_HOST_ID} .ad-xconfig-card-bg{inset:0}#${PANEL_HOST_ID} .ad-xconfig-card-bg::after{background:linear-gradient(90deg,rgba(27,31,41,.96) 0%,rgba(27,31,41,.88) 58%,rgba(27,31,41,.5) 100%)}#${PANEL_HOST_ID} .ad-xconfig-card-content,#${PANEL_HOST_ID} .ad-xconfig-card--theme-global .ad-xconfig-card-content{width:100%}#${PANEL_HOST_ID} .ad-xconfig-setting-row{grid-template-columns:minmax(0,1fr)}#${PANEL_HOST_ID} .ad-xconfig-setting-input > .ad-xconfig-switch{float:none}#${PANEL_HOST_ID} .ad-xconfig-modal{padding:0 16px 16px}#${PANEL_HOST_ID} .ad-xconfig-modal-header{padding-top:16px}#${PANEL_HOST_ID} .ad-xconfig-transfer-dialog{padding:16px}#${PANEL_HOST_ID} .ad-xconfig-modal-actions{flex-wrap:wrap;justify-content:flex-end}#${PANEL_HOST_ID} .ad-xconfig-transfer-summary{grid-template-columns:minmax(0,1fr)}}
@media(max-width:640px){#${PANEL_HOST_ID} .ad-xconfig-card-bg::after{background:linear-gradient(90deg,rgba(27,31,41,.90) 0%,rgba(27,31,41,.72) 55%,rgba(27,31,41,.46) 78%,rgba(27,31,41,.28) 100%)}}
@media(prefers-reduced-motion:reduce){#${PANEL_HOST_ID} .ad-xconfig-card,#${PANEL_HOST_ID} .ad-xconfig-switch-track,#${PANEL_HOST_ID} .ad-xconfig-switch-thumb,#${PANEL_HOST_ID} .ad-xconfig-switch-option{transition:none}}
