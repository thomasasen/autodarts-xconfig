...
export const xconfigDescriptors = Object.freeze([
  ...
  descriptorEntry({
    ...
    description: "Setzt Treffer-Highlights mit frei wählbarem Farbstil und Animationsstil.",
    fields: [
      selectField("colorTheme", "Farbstil", [
        { value: "ember-rush", label: "Ember Rush" },
        { value: "ice-circuit", label: "Ice Circuit" },
        { value: "volt-lime", label: "Volt Lime" },
        { value: "crimson-steel", label: "Crimson Steel" },
        { value: "arctic-mint", label: "Arctic Mint" },
        { value: "champagne-night", label: "Champagne Night" },
      ]),
      selectField("animationStyle", "Animationsstil", [
        { value: "impact-pop", label: "Impact Pop" },
        { value: "shockwave", label: "Shockwave" },
        { value: "sweep-shine", label: "Sweep Shine" },
        { value: "neon-pulse", label: "Neon Pulse" },
        { value: "snap-bounce", label: "Snap Bounce" },
        { value: "card-slam", label: "Card Slam" },
        { value: "signal-blink", label: "Signal Blink" },
        { value: "stagger-wave", label: "Stagger Wave" },
        { value: "flip-edge", label: "Flip Edge" },
        { value: "outline-trace", label: "Outline Trace" },
        { value: "charge-release", label: "Charge Release" },
        { value: "alternate-flick", label: "Alternate Flick" },
      ]),
      checkboxField("debug", "Debug"),
    ],
  }),
