...
export const xconfigDescriptors = Object.freeze([
  ...
  descriptorEntry({
    ...
    fields: [
      ...
      selectField("effect", "Effekt", [
        { value: "off", label: "Aus" },
        { value: "pulse-on-change", label: "Pulse on Change" },
        { value: "sheen-sweep", label: "Sheen Sweep" },
        { value: "charge-release", label: "Charge Release" },
        { value: "burn-down", label: "Burn Down" },
        { value: "spark-trail", label: "Spark Trail" },
        { value: "heat-edge", label: "Heat Edge" },
        { value: "segment-pop", label: "Segment Pop" },
        { value: "danger-flicker", label: "Danger Flicker" },
        { value: "checkout-glow", label: "Checkout Glow" },
      ]),
      checkboxField("debug", "Debug"),
    ],
  }),
  ...
  descriptorEntry({
    ...
    fields: [
      ...
      selectField("animationStyle", "Animationsstil", [
        { value: "impact-pop", label: "Slam Punch" },
        { value: "shockwave", label: "Shock Ring" },
        { value: "sweep-shine", label: "Laser Sweep" },
        { value: "neon-pulse", label: "Reactor Pulse" },
        { value: "snap-bounce", label: "Turbo Bounce" },
        { value: "card-slam", label: "Card Hammer" },
        { value: "signal-blink", label: "Glitch Blink" },
        { value: "stagger-wave", label: "Cascade Split" },
        { value: "flip-edge", label: "Rotor Flip" },
        { value: "outline-trace", label: "Edge Runner" },
        { value: "charge-release", label: "Charge Burst" },
        { value: "alternate-flick", label: "Beacon Flicker" },
      ]),
      checkboxField("debug", "Debug"),
    ],
  }),
