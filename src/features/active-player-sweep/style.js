export const STYLE_ID = "ad-ext-active-player-sweep-style";
export const SWEEP_CLASS = "ad-ext-active-player-sweep";
...
export function resolveActivePlayerSweepConfig(featureConfig = {}) {
...
.${SWEEP_CLASS}::after {
  ...
  animation: ad-ext-active-player-sweep ${durationMs}ms ease-out ${sweepDelayMs}ms 1;
  pointer-events: none;
}

@keyframes ad-ext-active-player-sweep {
