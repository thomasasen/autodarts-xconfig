...
export function initializeCheckoutTargetHighlights(context = {}) {
  ...
  const featureConfig =
    config && typeof config.getFeatureConfig === "function"
      ? config.getFeatureConfig("checkoutTargetHighlights")
      : {
          visualPreset: "focus",
          singleRing: "both",
...
export const mountCheckoutTargetHighlights = initializeCheckoutTargetHighlights;
export const initialize = initializeCheckoutTargetHighlights;
export const mount = initializeCheckoutTargetHighlights;
