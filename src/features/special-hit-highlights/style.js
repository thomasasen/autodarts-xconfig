...
export const HIT_ANIMATION_CLASS = Object.freeze({
  "pop-hit": "ad-ext-hit-animation--pop-hit",
  "side-shake": "ad-ext-hit-animation--side-shake",
  "glow-pop": "ad-ext-hit-animation--glow-pop",
  "flip-spin": "ad-ext-hit-animation--flip-spin",
  "light-sweep": "ad-ext-hit-animation--light-sweep",
  "shockwave-ring": "ad-ext-hit-animation--shockwave-ring",
...
.ad-ext-turn-throw.${HIT_BASE_CLASS}::after {
  ...
  box-shadow:
    ...
    0 0 calc(var(--ad-ext-hit-shadow-size) * 0.45) var(--ad-ext-hit-soft-glow),
...
.ad-ext-turn-throw.${HIT_BASE_CLASS}.${HIT_ANIMATION_CLASS["electric-jolt"]}.${HIT_ANIMATION_TRIGGER_CLASS}::before {
  ...
  box-shadow:
    inset 0 0 0 1px rgba(255, 255, 255, 0.08),
    inset 0 0 8px color-mix(in srgb, var(--ad-ext-hit-edge) 18%, transparent),
    0 0 12px color-mix(in srgb, var(--ad-ext-hit-glow) 42%, white 58%),
    0 0 24px color-mix(in srgb, var(--ad-ext-hit-soft-glow) 46%, white 54%);
  filter: var(--ad-ext-hit-electric-filter-strong);
  animation:
    ad-ext-hit-electric-jolt-frame-electric 760ms steps(4, end),
...
.ad-ext-turn-throw.${HIT_BASE_CLASS}.${HIT_ANIMATION_CLASS["electric-jolt"]}.${HIT_ANIMATION_TRIGGER_CLASS}::after {
  ...
  box-shadow: none;
  filter: var(--ad-ext-hit-electric-filter-soft) brightness(1.02);
...
@keyframes ad-ext-hit-row-pop-hit {
...
@keyframes ad-ext-hit-row-side-shake {
...
@keyframes ad-ext-hit-row-glow-pop {
...
@keyframes ad-ext-hit-row-flip-spin {
...
@keyframes ad-ext-hit-row-light-sweep {
...
@keyframes ad-ext-hit-light-sweep-surface {
  0% {
    opacity: 0.58;
...
@keyframes ad-ext-hit-row-shockwave-ring {
...
@keyframes ad-ext-hit-row-electric-jolt {
  0% {
...
@keyframes ad-ext-hit-score-electric-jolt {
  0% {
  ...
  24% {
    ...
    filter: brightness(1.24) drop-shadow(0 0 7px rgba(221,249,255,.56));
  }
  48% {
    transform: translateX(-1.6px) scale(1.06);
    letter-spacing: 0.05em;
    filter: brightness(1.14) drop-shadow(0 0 5px rgba(180,250,255,.38));
  }
  70% {
...
@keyframes ad-ext-hit-segment-electric-jolt {
  0% {
...
@keyframes ad-ext-hit-electric-jolt-frame-electric {
  0%, 100% {
  ...
  38% {
    ...
    filter: var(--ad-ext-hit-electric-filter-strong) brightness(1.12) saturate(1.08);
  }
  72% {
    transform: translate(1.1px, -.8px);
    filter: var(--ad-ext-hit-electric-filter-strong) brightness(1.06) saturate(1.04);
  }
}

@keyframes ad-ext-hit-electric-jolt-frame-glow {
  0%, 100% {
    box-shadow:
      inset 0 0 0 1px rgba(255, 255, 255, 0.1),
      inset 0 0 12px color-mix(in srgb, var(--ad-ext-hit-edge) 24%, transparent),
      0 0 18px color-mix(in srgb, var(--ad-ext-hit-soft-glow) 58%, white 42%),
      0 0 34px color-mix(in srgb, var(--ad-ext-hit-glow) 46%, white 54%);
    opacity: 0.82;
  }
  44% {
    box-shadow:
      inset 0 0 0 1px rgba(255, 255, 255, 0.16),
      inset 0 0 18px color-mix(in srgb, var(--ad-ext-hit-edge) 34%, transparent),
      0 0 24px color-mix(in srgb, var(--ad-ext-hit-soft-glow) 64%, white 36%),
      0 0 48px color-mix(in srgb, var(--ad-ext-hit-glow) 54%, white 46%);
    opacity: 1;
  }
}

@keyframes ad-ext-hit-electric-jolt-frame-aura {
  0%, 100% {
    opacity: 0.52;
    transform: scale(1);
  }
