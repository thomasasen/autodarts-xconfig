...
export function initializeSpecialHitHighlights(context = {}) {
  ...
  const featureConfig =
    config && typeof config.getFeatureConfig === "function"
      ? config.getFeatureConfig("specialHitHighlights")
      : {
  ...
  const scheduler = schedulerFactory(() => {
    ...
    emitDebugLog(
      ...
      `state apiVersion="${runtimeApiVersion}" rowSource="${stats.rowSource}" turnContainer=${
        ...
        Number(stats.burstCount) || 0
      } idleLoops=${Number(stats.idleLoopCount) || 0} removed=${Number(stats.removedCount) || 0} turnScore="${
        stats.turnScoreToken || "-"
...
export const mountSpecialHitHighlights = initializeSpecialHitHighlights;
export const initialize = initializeSpecialHitHighlights;
export const mount = initializeSpecialHitHighlights;
