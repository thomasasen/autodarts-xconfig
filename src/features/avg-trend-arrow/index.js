import { updateAvgTrendArrows } from "./logic.js";
...
const FEATURE_KEY = "avg-trend-arrow";
const OBSERVER_KEY = `${FEATURE_KEY}:dom-observer`;

export function initializeAvgTrendArrow(context = {}) {
  ...
  const featureConfig =
    config && typeof config.getFeatureConfig === "function"
      ? config.getFeatureConfig("avgTrendArrow")
      : {
          durationMs: 320,
          size: "standard",
        };
...
export const mountAvgTrendArrow = initializeAvgTrendArrow;
export const initialize = initializeAvgTrendArrow;
export const mount = initializeAvgTrendArrow;
