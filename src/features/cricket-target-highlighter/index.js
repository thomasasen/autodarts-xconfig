...
export function initializeCricketTargetHighlighter(context = {}) {
  ...
  const featureConfig =
    config && typeof config.getFeatureConfig === "function"
      ? config.getFeatureConfig("cricketTargetHighlighter")
      : {
...
export const mountCricketTargetHighlighter = initializeCricketTargetHighlighter;
export const initialize = initializeCricketTargetHighlighter;
export const mount = initializeCricketTargetHighlighter;
