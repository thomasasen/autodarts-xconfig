...
import { STYLE_ID, buildStyleText, resolveDartboardMarkerHighlightConfig } from "./style.js";

const FEATURE_KEY = "dartboard-marker-highlight";
...
export function hasRelevantDartboardMarkerHighlightMutation(mutations = [], state = null) {
...
export function initializeDartboardMarkerHighlight(context = {}) {
  ...
  const featureConfig =
    config && typeof config.getFeatureConfig === "function"
      ? config.getFeatureConfig("dartboardMarkerHighlight")
      : {
          size: 6,
  ...
  const visualConfig = resolveDartboardMarkerHighlightConfig(featureConfig);
...
export const initialize = initializeDartboardMarkerHighlight;
export const mount = initializeDartboardMarkerHighlight;
