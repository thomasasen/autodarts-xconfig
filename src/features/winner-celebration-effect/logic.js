...
export function createWinnerCelebrationEffectState(options = {}) {
  return {
...
export function stopWinnerCelebrationEffect(state) {
  if (!state) {
    return;
  }
...
export function startWinnerCelebrationEffect(state) {
...
export function syncWinnerCelebrationEffect(state, winnerSignal) {
