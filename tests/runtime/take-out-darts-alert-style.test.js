...
test("take-out-darts-alert style isolates the overlay, hides the host, and pulses only the card", () => {
...
test("take-out-darts-alert style maps image size presets onto the visible overlay image", () => {
